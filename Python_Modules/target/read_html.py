...
def calculate_dict(path):
    ...
    for file in files:
        ...
        pages_dict = [ {"upc": '190198429612', "zipcode":  address_ex[i].split()[-1], "priceoff": discount[i], \
...
#Python_Modules\target\target

page_dict_list.append(calculate_dict('Python_Modules/target/target/*.html'))
