...
def scrape_endpoint(sku):
    ...
    sql='SELECT zip FROM city_zip_data LIMIT 3'
...
def write_to_db(zip_codes):
    ...
    pages_data_df.to_sql('market_scraped_data', engine, dtype={col_name: sqlalchemy.types.VARCHAR for col_name in pages_data_df})
